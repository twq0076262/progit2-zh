...
Figure 5-6. 合并了 origin/master 之后 John 的仓库
...
Figure 5-9. 抓取 John 的改动后 Jessica 的历史
...
Figure 5-10. 合并了 John 的改动后 Jessica 的历史
...
Figure 5-12. 一个简单的多人 Git 工作流程的通常事件顺序
私有管理团队
...
Figure 5-14. 在一个特性分支提交后 Jessica 的历史
...
这样会重写你的历史，现在看起来像是 Figure 5-18

![](images/75.png)

Figure 5-18. featureA 工作之后的提交历史
...
Figure 5-19. featureBv2 工作之后的提交历史
### 通过邮件的公开项目
