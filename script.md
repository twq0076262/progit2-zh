...
首先我们来看一下服务。 钩子与服务整合都可以在仓库的设置区块中找到，就在我们之前添加协作者与改变项目的默认分支的地方。 在 “Webhooks and Services” 标签下你会看到与 Figure 6-49 类似的内容。

![](images/134.png)

Figure 6-49. 服务与钩子配置区域
有许多可以选择的服务，大多数是整合到其他的商业与开源系统中。 它们中的大多数是为了整合持续集成服务、BUG 与问题追踪系统、聊天室系统与文档系统。 我们将会通过设置一个非常简单的例子来介绍。 如果从 “Add Service” 选择 “email”，会得到一个类似 Figure 6-50 的配置屏幕。

![](images/135.png)

Figure 6-50. 电子邮件服务配置
...
为了启用一个钩子，点击 Figure 6-49 中的 “Add webhook” 按钮。 这会将你引导至一个类似 Figure 6-51 的页面。

![](images/136.png)

Figure 6-51. Web 钩子配置
...
Figure 6-53. 从设置页的 “Applications” 标签生成访问令牌。
...
现在如果进入到那个问题，可以看到我们刚刚发布的评论，像 Figure 6-54 一样。

![](images/139.png)

Figure 6-54. 从 GitHub API 发布的一条评论
...
如果某人在 GitHub 中打开了一个新的 Pull Request 并且这个钩子已经设置，会看到类似 Figure 6-55 的信息。

![](images/140.png)

Figure 6-55. 通过 API 的提交状态
